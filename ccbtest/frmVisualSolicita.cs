...
namespace ccbtest
{
    public partial class frmVisualSolicita : Form
    {
        public frmVisualSolicita(Form forms, DataGridView gridPesquisa, List<MOD_departamento> lista)
        {
            InitializeComponent();
        ...
        private void salvar()
        {
            try
            {
                if (ValidarControles().Equals(true))
                {
                    ...
                    {
                        ((frmPreTesteBusca)formChama).carregaGrid("Departamento", objEnt.CodDepartamento, string.Empty, dataGrid);
                    }

...
{
    public class BLL_pessoaMetodo : IBLL_PessoaMetodo
    {

        IDAL_PessoaMetodo objDAL;
        IBLL_buscaPessoaMetodo objBLL;
        ...
        /// <returns></returns>
        public bool Update(List<MOD_pessoaMetodo> lista)
        {
                    ...
                    if (lista != null && lista.Count > 0)
                    {
                        ...
                        foreach (MOD_pessoaMetodo ent in lista)
                        {
                            ...
                            else //Caso o Instruemnto não esteja marcado
                            {
                                ...
                                {
                                    //Chama a função que converte as datas
                                    ent.Logs = new BLL_pessoaMetodo_Log().CriarLog(ent, "Delete");
                                    ent.Logs = new BLL_pessoaMetodo_Log().ValidaLog(ent.Logs);

...
{
    public class BLL_buscaPessoaMetodoPorPessoa : IBLL_buscaPessoaMetodo
    {
        DataTable objDtb = null;
        List<MOD_pessoaMetodo> lista = new List<MOD_pessoaMetodo>();
        IDAL_buscaPessoaMetodo objDAL = new DAL_buscaPessoaMetodo();
        ...
        public List<MOD_pessoaMetodo> Buscar(string codPessoa)
        {
            try
            {
                ...
                if (null != objDtb)
                {
                    lista = new BLL_listaPessoaMetodo().CriarLista(objDtb);
                }
                return lista;
            }
        ...
        /// <summary>
        /// Função que Transmite a Pessoa, Metodo e a Situação informado, para pesquisa
        /// </summary>
        /// <param name="codPessoa"></param>
        /// <param name="codMetodo"></param>

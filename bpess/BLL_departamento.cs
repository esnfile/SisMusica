    ...
    public class BLL_departamento
    {
        ...
        private MOD_log criarLog(MOD_departamento ent, string Operacao)
        {
            try
            {
                ...
                {
                    ent.Logs.CodRotina = Convert.ToString(entAcesso.rotInsDepartamento);
                }
                else if (Operacao.Equals("Update"))
                {
                    ent.Logs.CodRotina = Convert.ToString(entAcesso.rotEditDepartamento);
                }
                else if (Operacao.Equals("Delete"))
                {
                    ent.Logs.CodRotina = Convert.ToString(entAcesso.rotExcDepartamento);
                }

...
namespace BLL.uteis
{
    public class BLL_cidade
    {
        ...
        private MOD_log criarLog(MOD_cidade ent, string Operacao)
        {
            try
            {
                MOD_acessoCidade MOD_acessoCidade = new MOD_acessoCidade();
                ...
                {
                    ent.Logs.CodRotina = MOD_acessoCidade.RotInsCidade.ToString();
                }
                else if (Operacao.Equals("Update"))
                {
                    ent.Logs.CodRotina = MOD_acessoCidade.RotEditCidade.ToString();
                }
                else if (Operacao.Equals("Delete"))
                {
                    ent.Logs.CodRotina = MOD_acessoCidade.RotExcCidade.ToString();
                }

...
namespace ccbimp
{
    public partial class frmPesquisaCidadeImp : Form
    {
        public frmPesquisaCidadeImp()
        {
            InitializeComponent();
            try
            {
        ...
        private void btnPesq_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtCidade.Text))
                {
                    ...
                    {
                        carregaGrid(txtCidade.Text, cboEstado.Text, txtEndereco.Text, txtBairro.Text);
                    }
                }
                else
                {
        ...
        private void frmCidadePesquisaImp_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frmCidadePesquisaImp_Activated(object sender, EventArgs e)
        {
            defineFoco();
        }
        ...
        internal void carregaGrid(string Cidade, string Estado, string Endereco, string Bairro)
        {
            try
            {

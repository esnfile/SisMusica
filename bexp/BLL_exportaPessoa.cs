...
{
    public class BLL_exportaPessoa
    {
        ...
        /// <returns></returns>
        public List<MOD_exportaPessoa> buscarCod(string CodExportaPessoa)
        {
            try
            {
                objDAL = new DAL_exportaPessoa();
                objDtb = objDAL.buscarCod(CodExportaPessoa);

                if (objDtb != null)
                {
                    listaExporta = this.criarLista(objDtb);
                }
                return listaExporta;
            }
            catch (SqlException exl)
        ...
        /// <returns></returns>
        public List<MOD_exportaPessoa> buscarDataExporta(string DataInicial, string DataFinal)
        {
            try
            {
                objDAL = new DAL_exportaPessoa();
                objDtb = objDAL.buscarDataExporta(funcoes.DataInt(DataInicial), funcoes.DataInt(DataFinal));
        ...
        /// </summary>
        /// <returns></returns>
        public List<MOD_exportaPessoa> buscarDataUltimoRegistro()
        {
            try
            {
                objDAL = new DAL_exportaPessoa();
                objDtb = objDAL.buscarDataUltimoRegistro();

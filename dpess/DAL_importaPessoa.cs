...
namespace DAL.pessoa
{
    public class DAL_importaPessoa
    {
        ...
        private string strInsert = "INSERT INTO ImportaPessoa (CodImportaPessoa, DataImporta, HoraImporta, CodUsuario, QtdeArquivo) " +
"VALUES (@CodImportaPessoa, @DataImporta, @HoraImporta, @CodUsuario, @QtdeArquivo) ";
...
"WHERE CodImportaPessoa = @CodImportaPessoa ";
        ...
        private string strSelect = "SELECT I.CodImportaPessoa, I.DataImporta, I.CodUsuario, I.HoraImporta, I.QtdeArquivo, " +
